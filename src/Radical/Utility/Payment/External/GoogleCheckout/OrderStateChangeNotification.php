...
class OrderStateChangeNotification extends Message {
	 ...
	 * 
	 * @param
	 *        	XmlMLElement An XML data structure
	 ...
	 */
	function previousFulfillmentState() {
		return $this->previousFulfillmentState;
	}
	/**
	 *
	 * @return string The <em>previous</em> financial state of the order.
	 */
	function previousFinancialState() {
		return $this->previousFinancialState;
	}
}