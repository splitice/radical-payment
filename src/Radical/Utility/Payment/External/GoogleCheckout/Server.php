...
abstract class Server {
	...
	/**
	 * This method is invoked for servers that are intended to receive
	 * notifications from Google Checkout via the XML based protocol.
	 * This
	 * method requires that you preprocess content from PHP's
	 * $HTTP_RAW_POST_DATA and pass it in yourself.
	 *
	 * @param
	 *        	string The raw XML request message.
	 * @return GoogleMessage A response message.
	 */
	function handleXML($request) {
		$message = XMLMessageFactory::create ( $request );
		return $this->handle ( $message );
	}
	 ...
	 *
	 * @param
	 *        	GoogleMessage The request to be processed.
	...
	/**
	 * This is the base implementation for processing a charge request.
	 * It
	 ...
	 *
	 * @param
	 *        	GoogleMessage A request message.
	 * @access private
	 */
	 ...
	 *
	 * @param
	 *        	string A Google Checkout order number.
	 * @access private
	 */
	 ...
	 * the status of the item to DELIVERED.
	 * You may optionally indicate
	 * if you want the purchaser to be notified via email.
	 *
	 * @param
	 *        	string An Google Checkout order number.
	 * @param
	 *        	boolean Whether or not to send an email to the purchaser
	 * @access private
	 */
	...
	/**
	 * This abstract method must be implemented by a sub-class.
	 * It is
	 * responsible for processing in some way a new order placed by a
	 * customer.
	 *
	 * @param
	 *        	NewOrderNotification A request message.
	 * @param
	 *        	GoogleMessage A response message.
	 * @abstract
	 *
	 *
	 */
	 ...
	 *
	 * @param
	 *        	OrderStateChangeNotification A request message.
	 * @param
	 *        	GoogleMessage A response message.
	 * @abstract
	 *
	 ...
	 *
	 * @param
	 *        	RiskInformationNotification A request message.
	 * @param
	 *        	GoogleMessage A response message.
	 * @abstract
	 *
	 ...
	 *
	 * @param
	 *        	ChargeAmountNotification A request message.
	 * @param
	 *        	GoogleMessage A response message.
	 * @abstract
	 *
	 ...
	 *
	 * @param
	 *        	MerchantCalculationCallback A request message.
	 * @param
	 *        	GoogleMessage A response message.
	 * @abstract
	 *
